...
```{r}
new.gif <- 1.41           ## choose your new GIF
...
hist(adj.pv_rod_CADO, main="REadjusted p-values (GIF=1.41)")
```
...
```{r}
new.gif <- 0.87           ## choose your new GIF
...
hist(adj.pv_rod_DIS, main="REadjusted p-values (GIF=0.87)")
```

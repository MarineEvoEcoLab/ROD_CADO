...
For CADO, I tested the following GIF values and report the number of outliers detected for each. Bolded values indicate the ones I chose to explore further:

...
bedtools merge -i <(mawk '!/CHR/' CONCON-treat.het| sort -k1,1 -k2,2n ) -c 4,5,7 -d -1 -o mean,mean,first > ../mean_treat_het/mean.CONCON.het
bedtools merge -i <(mawk '!/CHR/' STRCON-treat.het| sort -k1,1 -k2,2n ) -c 4,5,7 -d -1 -o mean,mean,first > ../mean_treat_het/mean.STRCON.het
bedtools merge -i <(mawk '!/CHR/' CONROD-treat.het| sort -k1,1 -k2,2n ) -c 4,5,7 -d -1 -o mean,mean,first > ../mean_treat_het/mean.CONROD.het
bedtools merge -i <(mawk '!/CHR/' STRROD-treat.het| sort -k1,1 -k2,2n ) -c 4,5,7 -d -1 -o mean,mean,first > ../mean_treat_het/mean.STRROD.het
